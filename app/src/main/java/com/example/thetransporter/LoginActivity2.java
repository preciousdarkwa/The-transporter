        ...
        btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(email.isEmpty()){
                    ...
                    mFirebaseAuth.signInWithEmailAndPassword(email, pwd).addOnCompleteListener(LoginActivity2.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull  Task<AuthResult> task) {
                            if(!task.isSuccessful()){
                                Toast.makeText(LoginActivity2.this, "Logn Error, Please login again !", Toast.LENGTH_SHORT).show();
                            }
                            else{
                    ...
                    Toast.makeText(LoginActivity2.this, "Error occured!", Toast.LENGTH_SHORT).show();
